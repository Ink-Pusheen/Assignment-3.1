...
//Upgrades the players click power by 2-5 and subtracts the players cookies by the upgrade cost and then raises the cost
function UpgradeClick(){
    if(totalcookies >= costToupgrade){
        totalcookies = totalcookies - costToupgrade
        clickpower = clickpower + (Math.floor((Math.random() * 5) + 2));
